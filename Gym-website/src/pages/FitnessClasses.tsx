...
const fitnessClasses = [
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1521804906057-1df8fdb718b7?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
  },
  {
    id: 3,
    name: 'Zumba',
    description: "Dance-based cardio workout that's fun, effective, and easy to follow.",
    image: 'https://plus.unsplash.com/premium_photo-1663054933667-fb307cea9aab?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
  },
  {
    id: 4,
    name: 'Cardio',
    description: 'Burn calories and improve heart health with high-energy workouts.',
    image: 'https://plus.unsplash.com/premium_photo-1683121008092-7c4e5c75f2ce?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
  }
];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {filteredClasses.map((fitnessClass) => (
            <div key={fitnessClass.id} className="flex flex-col">
              ...
              <Button 
                className="mt-2 w-full bg-black text-gray-300 hover:bg-black-700"
