...
const FitnessTracker = () => {
  return (
    <div className="flex min-h-screen bg-white text-black">
      {/* Sidebar */}
      <div className="w-16 bg-gray-200 flex flex-col items-center py-6 gap-8">
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <Card className="bg-gray-200 border-0">
                <CardContent className="p-4">
                  ...
                  <div className="text-xs text-gray-600 mb-1">55% of your goal</div>
                  <Progress value={55} className="h-1 bg-gray-300" />
                </CardContent>
              </Card>
            ...
            <div className="bg-gray-200 p-4 rounded-lg">
              <div className="flex justify-between items-center mb-4">
                ...
                <div className="flex items-center text-xs bg-gray-300 px-2 py-1 rounded">
                    ...
                    <div className="relative w-16 h-16">
                      <svg className="w-full h-full" viewBox="0 0 36 36">
                        ...
                        <circle 
                          ...
                          strokeDashoffset="0"
                        />
                        <text x="18" y="18" textAnchor="middle" fontSize="8" fill="#000" fontWeight="bold">45%</text>
                      </svg>
                    </div>
                  </div>
                </CardContent>
            ...
            <div className="bg-gray-200 p-4 rounded-lg">
              ...
              <div className="flex justify-center mb-6">
                <div className="relative w-28 h-28">
                  <svg className="w-full h-full" viewBox="0 0 36 36">
                    ...
                    />
                    <text x="18" y="18" textAnchor="middle" fontSize="6" fill="#000" fontWeight="bold">40hrs</text>
                    <text x="18" y="24" textAnchor="middle" fontSize="4" fill="#6B7280">Total</text>
                  </svg>
                </div>
              </div>
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-sm text-gray-600">15 hrs</span>
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-sm text-gray-600">10 hrs</span>
                </div>
              </div>
              
              <div className="flex justify-center mt-4">
                <ProgressLink className="text-gray-600 text-sm">View detailed progress</ProgressLink>
              </div>
            </div>
          </div>
        </div>
