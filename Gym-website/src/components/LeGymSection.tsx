            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="flex flex-col gap-2">
                <div className="flex gap-3 items-start">
                  <div className="feature-icon mb-1 mt-1 bg-gray-800" style={{ backgroundColor: 'grey' }}>
              ...
              <div className="flex flex-col gap-2">
                <div className="flex gap-3 items-start">
                  <div className="feature-icon mb-1 mt-1 bg-gray-900" style={{ backgroundColor: 'grey' }}>
                    <X className="w-4 h-4" />
                  </div>
                  <div>
              ...
              <div className="flex flex-col gap-2">
                <div className="flex gap-3 items-start">
                  <div className="feature-icon mb-1 mt-1 bg-zinc-800" style={{ backgroundColor: 'grey' }}>
